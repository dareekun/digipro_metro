<div class="container2">
                            ...
                            <table class="table table-striped table-border cell-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="button primary small" wire:click="show_edit({{$product->id}})"><span class="mif-pencil"></span></button>
                                            <button class="button alert small" wire:click="show_delete({{$product->id}})"><span class="mif-bin"></span></button>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
    ...
    <div wire:ignore class="dialog" data-role="dialog" id="add_product">
        ...
        <div class="dialog-content">
            ...
            <div class="row">
                ...
                <div class="cell-8"><input data-role="input" wire:model.defer="cycle_add" step=".01" data-clear-button="true"
    ...
    <div wire:ignore class="dialog" data-role="dialog" id="edit_product">
        ...
        <div class="dialog-content">
            <div class="row">
                <div class="cell-3">Product</div>
                <div class="cell-8"><input data-role="input" wire:model.defer="product_edit" data-clear-button="true"
                        required type="text">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="cell-3">Section</div>
                <div class="cell-8"><input data-role="input" wire:model.defer="section_edit" data-clear-button="true"
                        required type="text">
                </div>
            </div>
            <div class="row">
                <div class="cell-3">Cycle Time</div>
                <div class="cell-8"><input data-role="input" wire:model.defer="cycle_edit" step=".01" data-clear-button="true"
                        required type="number">
                </div>
            </div>
            <div class="row">
        ...
        <div class="dialog-actions">
            <button type="submit" class="button success">Save Product</button>
            <button class="button warning js-dialog-close">Cancel</button>
        </div>
        </form>
    </div>
